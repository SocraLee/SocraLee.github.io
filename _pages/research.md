...
May 2024 – Aug 2024, GE HealthCare
- Developed a multi-agent system for single cell analysis, enabling low-code solutions in the field.
- Streamlined programming into requirement parsing, API assignment, and parameter selection, each handled by an LLM group.
- Evaluated the multi-agent system against single language models, demonstrating significant improvements.


## GNN-based Cross-domain Recommender System
Feb 2021 – Aug 2021
- Developed a cross-domain recommender system to address cold-start issues.
